...
const baseArtistList: Artist[] = [
  ...
  { name: 'ONE OK ROCK', instagram: '@oneokrockofficial', region: 'jpop', description: '國際知名日本搖滾樂團', genre: 'rock' },
  ...
  { name: 'SPITZ', instagram: '@spitz__1987', region: 'jpop', description: '日本傳奇搖滾樂團', genre: 'rock' },
  { name: 'HYDE', instagram: '@hydeofficial', region: 'jpop', description: '日本攻殼機動隊等知名樂團主唱', genre: 'rock' },
  ...
  { name: 'Coldplay', instagram: '@coldplay', region: 'western', description: '英國搖滾傳奇樂團', genre: 'rock' },
  { name: 'Arctic Monkeys', instagram: '@arcticmonkeys', region: 'western', description: '英倫搖滾代表', genre: 'rock' },
  ...
  { name: 'Tame Impala', instagram: '@tameimpala', region: 'western', description: '澳洲迷幻搖滾大師', genre: 'rock' },
  { name: 'The Killers', instagram: '@thekillers', region: 'western', description: '美國搖滾樂團', genre: 'rock' },
  { name: 'Glass Animals', instagram: '@glassanimals', region: 'western', description: '英國另類搖滾樂團', genre: 'rock' },
  { name: 'LANY', instagram: '@lany', region: 'western', description: '美國indie pop 樂團', genre: 'pop' },
  { name: 'Vampire Weekend', instagram: '@vampireweekend', region: 'western', description: '美國indie rock 樂團', genre: 'rock' },
  { name: 'Pixies', instagram: '@pixiesofficial', region: 'western', description: '美國另類搖滾先驅', genre: 'rock' },
  { name: 'Big Thief', instagram: '@bigthiefmusic', region: 'western', description: '美國folk rock 樂團', genre: 'rock' },
  { name: 'Interpol', instagram: '@interpol', region: 'western', description: '美國post-punk 樂團', genre: 'rock' },
  { name: 'Slow Pulp', instagram: '@slowpulpband', region: 'western', description: '美國indie pop 樂團', genre: 'pop' },
  { name: 'The Beaches', instagram: '@thebeachesband', region: 'western', description: '加拿大indie rock 樂團', genre: 'rock' },
  { name: 'Phoebe Bridgers', instagram: '@phoebebridgers', region: 'western', description: '美國indie folk 才女', genre: 'pop' },
  { name: 'boygenius', instagram: '@boygenius', region: 'western', description: '美國超級樂團組合', genre: 'rock' },
  { name: 'Clairo', instagram: '@clairo', region: 'western', description: '美國indie pop 才女', genre: 'pop' },
  { name: 'beabadoobee', instagram: '@beadoobee', region: 'western', description: '英國indie rock 才女', genre: 'rock' },
  { name: 'The Marías', instagram: '@themarías', region: 'western', description: '美國dream pop 樂團', genre: 'pop' },
  { name: 'Men I Trust', instagram: '@menitrust', region: 'western', description: '加拿大另類搖滾樂團', genre: 'rock' },
  { name: 'Alvvays', instagram: '@alvvaysband', region: 'western', description: '加拿大indie rock 樂團', genre: 'rock' },
  { name: 'Fontaines D.C.', instagram: '@fontainesdc', region: 'western', description: '愛爾蘭post-punk 樂團', genre: 'rock' },
  { name: 'IDLES', instagram: '@idlesband', region: 'western', description: '英國punk 樂團', genre: 'rock' },
  { name: 'Wet Leg', instagram: '@wetlegband', region: 'western', description: '英國indie rock 樂團', genre: 'rock' },
  { name: 'Wolf Alice', instagram: '@wolfaliceband', region: 'western', description: '英國indie rock 樂團', genre: 'rock' },
  { name: 'The Last Dinner Party', instagram: '@thelastdinnerparty', region: 'western', description: '新興英國另類搖滾樂團', genre: 'rock' },
  { name: 'Ethel Cain', instagram: '@ethelcain', region: 'western', description: '美國gothic folk 才女', genre: 'rock' },
  ...
  { name: 'Paramore', instagram: '@paramore', region: 'western', description: '美國pop-punk 樂團', genre: 'rock' },
  { name: 'Fall Out Boy', instagram: '@fob', region: 'western', description: '美國pop-punk 樂團', genre: 'rock' },
  { name: 'Panic! at the Disco', instagram: '@panicatthedisco', region: 'western', description: '美國theatric-pop 樂團', genre: 'rock' },
  { name: 'Green Day', instagram: '@greenday', region: 'western', description: '美國punk rock 傳奇樂團', genre: 'rock' },
  { name: 'My Chemical Romance', instagram: '@mychemicalromance', region: 'western', description: '美國emo rock 樂團', genre: 'rock' },
  { name: 'The Smashing Pumpkins', instagram: '@thesmashingpumpkins', region: 'western', description: '美國另類搖滾傳奇樂團', genre: 'rock' },
  { name: 'Deftones', instagram: '@deftones', region: 'western', description: '美國nu-metal 樂團', genre: 'rock' },
